...
import { register, login, logout, refresh, forgotPassword, resetPasswordController, verifyEmail, getMe } from '../controllers/auth.controller';
...
authRouter.post('/refresh-token', validateRequest(refreshTokenSchema), refresh);
